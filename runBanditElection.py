...
## running the elections as a two level opinion survey with a bandit algorithm on top
## not sure if theoretically sound or not
            
def runBanditElectionOS(alpha, batch = 1, a = 1, b = 1):
