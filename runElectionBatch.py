...
def main():
	...
	if algorithm in ['U1', 'U2', 'USE', 'UGLR', 'DCB1', 'DCB2', 'DCBSE', 'DCBGLR', 'DCBSEEVE', 'USEEVE', 'UKLSN', 'DCBKLSN', 'UKLSNEVE', 'DCBKLSNEVE']:
